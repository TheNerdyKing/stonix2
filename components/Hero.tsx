    ...
    >
      <div ref={navRef} className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-2xl px-4 pointer-events-auto">
        <nav className="flex items-center justify-between px-6 py-4 bg-black/60 backdrop-blur-2xl rounded-full border border-white/10 shadow-[0_0_30px_rgba(0,0,0,0.8)]">
          ...
          <div className="hidden md:flex items-center gap-8 px-4">
            ...
            <a href="#work" className="text-white/60 hover:text-white text-xs uppercase tracking-[0.2em] font-medium transition-colors cursor-pointer">Results</a>
            <a href="#contact" className="text-white/60 hover:text-white text-xs uppercase tracking-[0.2em] font-medium transition-colors cursor-pointer">Book a Call</a>
          </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-6 pt-32 pb-20">
          ...
          >
            Outcomes. <br className="hidden md:block" />
          ...
          >
            We handle full-funnel performance marketing so you can focus on scale. One clear goal: aggressive revenue growth.
          </p>
