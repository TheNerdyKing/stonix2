...
const PANELS = [
  {
    ...
    desc: "Scale your user acquisition profitably with data-driven paid media and aggressive search strategies.",
      ...
      <div className="flex-1 flex flex-col gap-4 md:gap-6 p-6 md:p-10 h-full">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            { label: "Ranked Keywords", val: "1,204", icon: Search },
            { label: "Domain Authority", val: "78", icon: Target }
          ].map((stat, i) => (
  ...
  },
  {
    ...
    desc: "Precision campaign management across leading platforms that generates high-quality, relevant leads.",
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 p-6 md:p-10 h-full">
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-orange-500/10 rounded-2xl h-14 md:h-16 border border-orange-500/20 flex items-center justify-between px-6">
            <span className="text-orange-500 font-bold text-sm">Target CPL</span>
  ...
  },
  {
    key: "brand",
    title: "Creative & CRO",
    desc: "Ad creatives that convert and landing pages optimized to turn clicks into predictable revenue.",
  ...
  },
  {
    ...
    desc: "Server-side tracking and attribution so every dollar is accounted for and optimized.",
    ...
    MockUI: () => (
      <div className="flex-1 flex flex-col p-6 md:p-10 h-full relative overflow-hidden">
        ...
        <div className="text-[10px] text-white/40 uppercase tracking-widest mb-6 px-2">Data Pipelines</div>
